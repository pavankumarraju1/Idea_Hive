...
const Loginpage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const loginData = await axiosInstance.post("/auth/login", data, {
                headers: {
            ...
            dispatch(addUser(loginData?.data?.user))

            nav('/land')
            toast(loginData.data.message, {style: {
                borderRadius: '10px',
                background: '#333',
                color: '#fff',
            }})
    ...
    return (
        <div className='flex flex-col justify-center px-5 py-12 sm:px-6 lg:px-8 mb-10 text-white'>
            <motion.div
